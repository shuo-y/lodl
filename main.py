...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, choices=["dense", "dense_coupled", "xgb_decoupled", "xgb_lodl", "xgb_lodl_decoupled", "xgb_coupled", "xgb_coupled_clf", "xgb_search", "xgb_search_decoupled", "xgb_ngopt", "xgb_smac"], default="dense")
    ...
    parser.add_argument("--search_budget", type=int, default=200, help="budget for never grad search or smac")
    ...
    if args.model == "xgb_decoupled":
        ...
        perf_test = perf_booster(args, problem, booster, xtest, ytest, "test")
        print(f"DQ_seed{args.seed},{perf_train}{perf_test}{perf_val}")
    elif args.model == "xgb_smac":
        from train_xgb import perf_booster
        from train_xgb import train_xgb_smac
        booster = train_xgb_smac(args, prob, probkwargs, xtrain, ytrain, xval, yval)
